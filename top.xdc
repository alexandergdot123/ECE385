...
set_property PACKAGE_PIN J1 [get_ports load_b]
set_property PACKAGE_PIN N15 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS25 [get_ports load_b]
...
# Mapping regA[7:0] to LEDs (LED8 to LED15)
set_property PACKAGE_PIN C17 [get_ports {regA[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[0]}]
set_property PACKAGE_PIN B18 [get_ports {regA[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[1]}]
set_property PACKAGE_PIN A17 [get_ports {regA[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[2]}]
set_property PACKAGE_PIN B17 [get_ports {regA[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[3]}]
set_property PACKAGE_PIN C18 [get_ports {regA[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[4]}]
set_property PACKAGE_PIN D18 [get_ports {regA[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[5]}]
set_property PACKAGE_PIN E18 [get_ports {regA[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[6]}]
set_property PACKAGE_PIN G17 [get_ports {regA[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regA[7]}]

# Mapping regB[7:0] to LEDs (LED0 to LED7)
set_property PACKAGE_PIN C13 [get_ports {regB[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[0]}]
set_property PACKAGE_PIN C14 [get_ports {regB[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[1]}]
set_property PACKAGE_PIN D14 [get_ports {regB[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[2]}]
set_property PACKAGE_PIN D15 [get_ports {regB[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[3]}]
set_property PACKAGE_PIN D16 [get_ports {regB[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[4]}]
set_property PACKAGE_PIN F18 [get_ports {regB[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[5]}]
set_property PACKAGE_PIN E17 [get_ports {regB[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[6]}]
set_property PACKAGE_PIN D17 [get_ports {regB[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {regB[7]}]
